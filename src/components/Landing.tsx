    ...
    <div className="mx-auto max-w-5xl px-6 pb-24 pt-14 sm:pt-20">
      <div className="relative">
        ...
        <h1 className="mt-4 max-w-2xl text-balance font-display text-4xl leading-[1.08] text-ink sm:text-6xl">
          Books that know where you're going.
        </h1>
        <p className="mt-5 max-w-xl text-balance font-serif text-lg leading-relaxed text-ink-soft">
          {singleFlow
            ? 'Marginalia lets you search for books to match your travel destinations, letting you travel with those who have been there before.'
            : "Marginalia recommends a short, curated list at a time, based on your travel plans or your role models' reading recommendations — all annotated with why each one earns its spot."}
        </p>
      </div>
      ...
      <div className={singleFlow ? 'mt-10 max-w-2xl' : 'mt-14 grid gap-6 sm:grid-cols-2'}>
        ...
        >
          ...
          <p className="mt-3 font-serif text-[15px] leading-relaxed text-ink-soft">
            Tell us where you're headed. We'll give you a short reading list to set the scene
            before you arrive.
          </p>
      ...
      <p className="mx-auto mt-16 max-w-lg text-center font-mono text-[11px] leading-relaxed text-ink-faint">
        ...
        API in 2020.{!singleFlow && ' Recommendations are limited to publicly documented lists and interviews.'}
      </p>
    </div>
  )
}
